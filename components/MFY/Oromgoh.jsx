...
const getTopics = async () => {
    ...
    try {
        ...
        const filteredTopics = topiclar.filter((topic) => {
            ...
            return createdAt > filterDate && topic.MFY === '<option>Файзуллаев Иброхим Жунайдулло ўғли  (OROMGOH MFY)</option>';
        });
        ...
        const fetchTopics = async () => {
            try {
                ...
                const filteredTopicsByMFY = newFilteredTopics.filter(
                    (topic) => topic.MFY === '<option>Файзуллаев Иброхим Жунайдулло ўғли  (OROMGOH MFY)</option>'
                );
