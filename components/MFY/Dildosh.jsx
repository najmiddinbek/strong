...
const getTopics = async () => {
    ...
    try {
        ...
        const filteredTopics = topiclar.filter((topic) => {
            ...
            return createdAt > filterDate && topic.MFY === '    <option>Жўраев Рахматилло Сайдвалиевич (DILDOSH MFY)</option>';
        });
        ...
        const fetchTopics = async () => {
            try {
                ...
                const filteredTopicsByMFY = newFilteredTopics.filter(
                    (topic) => topic.MFY === '    <option>Жўраев Рахматилло Сайдвалиевич (DILDOSH MFY)</option>'
                );
