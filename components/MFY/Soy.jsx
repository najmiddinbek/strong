...
const getTopics = async () => {
    ...
    try {
        ...
        const filteredTopics = topiclar.filter((topic) => {
            ...
            return createdAt > filterDate && topic.MFY === ' <option>Қосимов Достон Рустам ўғли  (SOY MFY)</option>';
        });
        ...
        const fetchTopics = async () => {
            try {
                ...
                const filteredTopicsByMFY = newFilteredTopics.filter(
                    (topic) => topic.MFY === ' <option>Қосимов Достон Рустам ўғли  (SOY MFY)</option>'
                );
