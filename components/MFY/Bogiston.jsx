...
const getTopics = async () => {
    ...
    try {
        ...
        const filteredTopics = topiclar.filter((topic) => {
            ...
            return createdAt > filterDate && topic.MFY === 'Мамасодиқов Ботиржон Зокиржон ўғли  (BOG`ISTON MFY)';
        });
        ...
        const fetchTopics = async () => {
            try {
                ...
                const filteredTopicsByMFY = newFilteredTopics.filter(
                    (topic) => topic.MFY === 'Мамасодиқов Ботиржон Зокиржон ўғли  (BOG`ISTON MFY)'
                );
